...
class CLIP(nn.Module):
    ...
    def forward(self, image, text):
        ...
        image_features,image_features_batch = self.encode_image(image)
        #print("==================",image_features.shape)
        text_features,text_features_batch = self.encode_text(text)
        ...
        return logits_per_image, text_features, image_features,image_features_batch,text_features_batch
